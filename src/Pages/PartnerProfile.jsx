      ...
      <div className="container border  border-gray-200 rounded-lg mx-auto shadow-2xl m-4 p-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-7">
            ...
            <h6 className="mt-4 font-semibold">Monday, February 10</h6>
            <div className="flex flex-wrap gap-2 my-3">
              {dates.map((date, index) => (
                <button
                  key={index}
                  className={`px-4 py-2 border rounded-md border-[#B58152] hover:bg-[#f6e2d0] ${
                    index === 0 ? "bg-[#f6e2d0]" : ""
                  }`}
                >
                  {date.day} {date.date}
            ...
            <h6 className="mt-3 font-semibold">Morning</h6>
            <div className="flex flex-wrap gap-2">
              {morningSlots.map((slot, index) => (
                <button
                  key={index}
                  className="px-4 py-2 border rounded-md border-[#B58152] hover:bg-[#f6e2d0]"
                  onClick={() => (window.location.href = "/payPage")}
                >
                  {slot}
                </button>
              ))}
            ...
            <h6 className="mt-3 font-semibold">Afternoon</h6>
            <div className="flex flex-wrap gap-2">
          ...
          <div className="md:col-span-5">
            <div className="border  border-gray-400 rounded-lg p-4">
              <img
                ...
                alt="salon"
              />
              <h5 className="text-lg font-semibold">Sohail & Body Salon</h5>
              <p className="text-gray-600">
                Premium hair services tailored to your style. Experienced
                stylists provide top-notch haircuts, coloring, and more.
              </p>
              <p className="my-2">
                <span className="font-bold">📞</span> 07 8180 3035
              </p>
              <p className="my-2">
                <span className="font-bold">📍</span> Mrjalhmam, Amman, Jordan
              </p>
              <p className="my-2">
                <span className="font-bold">📧</span> Sohail@gmail.com
              </p>
